...
export declare class Stripe {
     ...
     */
    static MAJOR_API_VERSION: string;
     ...
     * This may be removed in the future.
     */
    _getPropsFromConfig(config: StripeConfig | Record<string, unknown>): UserProvidedConfig;
    /**
     * @private
     * This may be removed in the future.
     */
    ...
    _buildEventNotification(parsed: Record<string, unknown>): V2.Core.EventNotification;
    /**
     ...
     */
    parseEventNotificationWithoutVerification(payload: string): V2.Core.EventNotification;
}
...
export declare namespace Stripe {
    export { Account, DeletedAccount, AccountCreateParams, AccountRetrieveParams, AccountUpdateParams, AccountListParams, AccountDeleteParams, AccountCreateExternalAccountParams, AccountCreateLoginLinkParams, AccountCreatePersonParams, AccountDeleteExternalAccountParams, AccountDeletePersonParams, AccountListCapabilitiesParams, AccountListExternalAccountsParams, AccountListPersonsParams, AccountRejectParams, AccountRetrieveCurrentParams, AccountRetrieveCapabilityParams, AccountRetrieveExternalAccountParams, AccountRetrievePersonParams, AccountUnrejectParams, AccountUpdateCapabilityParams, AccountUpdateExternalAccountParams, AccountUpdatePersonParams, AccountResource, };
    ...
    export { PaymentRecord, PaymentRecordRetrieveParams, PaymentRecordListParams, PaymentRecordReportPaymentParams, PaymentRecordReportPaymentAttemptParams, PaymentRecordReportPaymentAttemptCanceledParams, PaymentRecordReportPaymentAttemptFailedParams, PaymentRecordReportPaymentAttemptGuaranteedParams, PaymentRecordReportPaymentAttemptInformationalParams, PaymentRecordReportRefundParams, PaymentRecordResource, };
    ...
    export namespace ErrorType {
        type StripeError = InstanceType<typeof _Error.StripeError>;
        type StripeCardError = InstanceType<typeof _Error.StripeCardError>;
        type StripeInvalidRequestError = InstanceType<typeof _Error.StripeInvalidRequestError>;
        type StripeAPIError = InstanceType<typeof _Error.StripeAPIError>;
        type StripeAuthenticationError = InstanceType<typeof _Error.StripeAuthenticationError>;
        type StripePermissionError = InstanceType<typeof _Error.StripePermissionError>;
        type StripeRateLimitError = InstanceType<typeof _Error.StripeRateLimitError>;
        type StripeConnectionError = InstanceType<typeof _Error.StripeConnectionError>;
        type StripeSignatureVerificationError = InstanceType<typeof _Error.StripeSignatureVerificationError>;
        type StripeIdempotencyError = InstanceType<typeof _Error.StripeIdempotencyError>;
        type StripeOAuthError = InstanceType<typeof _Error.StripeOAuthError>;
        type StripeInvalidGrantError = InstanceType<typeof _Error.StripeInvalidGrantError>;
        type StripeInvalidClientError = InstanceType<typeof _Error.StripeInvalidClientError>;
        type StripeOAuthInvalidRequestError = InstanceType<typeof _Error.StripeOAuthInvalidRequestError>;
