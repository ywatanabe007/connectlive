 ...
 */
export declare function parsePayload(payload: string | Uint8Array): Record<string, unknown>;
export declare function maybeExtractFromCloudProviderEnvelope(payload: string): Record<string, unknown>;
/**
