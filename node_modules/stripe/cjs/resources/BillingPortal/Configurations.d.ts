...
export declare namespace Configuration {
    ...
    namespace Features {
        ...
        namespace CustomerUpdate {
            type AllowedUpdate = 'address' | 'email' | 'name' | 'phone' | 'shipping' | 'tax_id' | OtherString;
        }
        namespace SubscriptionCancel {
            ...
            type Mode = 'at_period_end' | 'immediately' | OtherString;
            type ProrationBehavior = 'always_invoice' | 'create_prorations' | 'none';
            namespace CancellationReason {
                type Option = 'customer_service' | 'low_quality' | 'missing_features' | 'other' | 'switched_service' | 'too_complex' | 'too_expensive' | 'unused' | OtherString;
            }
        }
        namespace SubscriptionUpdate {
            type BillingCycleAnchor = 'now' | 'unchanged';
            type DefaultAllowedUpdate = 'price' | 'promotion_code' | 'quantity' | OtherString;
            interface Product {
            ...
            type TrialUpdateBehavior = 'continue_trial' | 'end_trial' | OtherString;
            namespace Product {
            ...
            namespace ScheduleAtPeriodEnd {
                ...
                namespace Condition {
                    type Type = 'decreasing_item_amount' | 'shortening_interval' | OtherString;
                }
            }
        }
    }
