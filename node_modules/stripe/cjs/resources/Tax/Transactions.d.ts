...
import { MetadataParam, OtherString, PaginationParams, Metadata, Address } from '../../shared.js';
...
export declare namespace Transaction {
    ...
    type Type = 'reversal' | 'transaction' | OtherString;
    namespace CustomerDetails {
        type AddressSource = 'billing' | 'shipping' | OtherString;
        interface TaxId {
            /**
        ...
        type TaxabilityOverride = 'customer_exempt' | 'none' | 'reverse_charge' | OtherString;
        namespace TaxId {
    ...
    namespace ShippingCost {
        type TaxBehavior = 'exclusive' | 'inclusive' | OtherString;
...
export declare namespace Tax {
    ...
    namespace TransactionCreateReversalParams {
        type Mode = 'full' | 'partial' | OtherString;
        interface LineItem {
            /**
