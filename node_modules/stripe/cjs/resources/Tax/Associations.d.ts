...
export declare namespace Association {
    ...
    namespace TaxTransactionAttempt {
        ...
        namespace Errored {
            type Reason = 'another_payment_associated_with_calculation' | 'calculation_expired' | 'currency_mismatch' | 'original_transaction_voided' | 'unique_reference_violation' | OtherString;
        }
    }
}
