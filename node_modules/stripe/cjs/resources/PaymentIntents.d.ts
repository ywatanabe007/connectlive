...
import { Emptyable, MetadataParam, OtherString, AddressParam, PaginationParams, RangeQueryParam, Metadata, Address } from '../shared.js';
...
export declare namespace PaymentIntent {
    ...
    type ConfirmationMethod = 'automatic' | 'manual' | OtherString;
    ...
    namespace AmountDetails {
        ...
        namespace Error {
            type Code = 'amount_details_amount_mismatch' | 'amount_details_tax_shipping_discount_greater_than_amount' | OtherString;
        }
    }
    ...
    namespace PaymentMethodOptions {
        ...
        namespace CardPresent {
            ...
            namespace Routing {
                type RequestedPriority = 'domestic' | 'international' | OtherString;
            }
        }
        namespace Cashapp {
            type SetupFutureUsage = 'none' | 'off_session' | 'on_session' | OtherString;
        ...
        namespace UsBankAccount {
            ...
            type SetupFutureUsage = 'none' | 'off_session' | 'on_session' | OtherString;
            type TransactionPurpose = 'goods' | 'other' | 'services' | 'unspecified' | OtherString;
            type VerificationMethod = 'automatic' | 'instant' | 'microdeposits' | OtherString;
        ...
        namespace WechatPay {
            type Client = 'android' | 'ios' | 'web' | OtherString;
        }
    }
...
export declare namespace PaymentIntentCreateParams {
    ...
    namespace AmountDetails {
        ...
        namespace LineItem {
            ...
            namespace PaymentMethodOptions {
                ...
                namespace Paypal {
                    type Category = 'digital_goods' | 'donation' | 'physical_goods' | OtherString;
                }
            }
        }
    }
    ...
    namespace PaymentMethodOptions {
        ...
        interface Payto {
             ...
             * If you've already set `setup_future_usage` and you're performing a request using a publishable key, you can only update the value from `on_session` to `off_session`.
             */
            setup_future_usage?: Emptyable<Payto.SetupFutureUsage>;
        }
        interface Pix {
            /**
        ...
        interface UsBankAccount {
             ...
             * The purpose of the transaction.
             */
            transaction_purpose?: Emptyable<UsBankAccount.TransactionPurpose>;
            /**
             * Bank account verification method. The default value is `automatic`.
             */
            verification_method?: UsBankAccount.VerificationMethod;
        ...
        namespace Sofort {
            type PreferredLanguage = 'de' | 'en' | 'es' | 'fr' | 'it' | 'nl' | 'pl' | OtherString;
            type SetupFutureUsage = 'none' | 'off_session' | OtherString;
        }
        namespace Twint {
            type SetupFutureUsage = 'none' | 'off_session' | OtherString;
