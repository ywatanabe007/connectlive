...
export declare namespace FinancialAccountFeatures {
    ...
    namespace CardIssuing {
        type Status = 'active' | 'pending' | 'restricted' | OtherString;
        ...
        namespace StatusDetail {
            type Code = 'activating' | 'capability_not_requested' | 'financial_account_closed' | 'rejected_other' | 'rejected_unsupported_business' | 'requirements_past_due' | 'requirements_pending_verification' | 'restricted_by_platform' | 'restricted_other' | OtherString;
            type Resolution = 'contact_stripe' | 'provide_information' | 'remove_restriction' | OtherString;
            type Restriction = 'inbound_flows' | 'outbound_flows' | OtherString;
        }
    }
