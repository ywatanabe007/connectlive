...
export declare namespace ReceivedDebit {
    type FailureCode = 'account_closed' | 'account_frozen' | 'insufficient_funds' | 'international_transaction' | 'other' | OtherString;
    ...
    type Network = 'ach' | 'card' | 'stripe' | OtherString;
    ...
    type Status = 'failed' | 'succeeded' | OtherString;
    namespace InitiatingPaymentMethodDetails {
        ...
        type Type = 'balance' | 'financial_account' | 'issuing_card' | 'stripe' | 'us_bank_account' | OtherString;
    ...
    namespace ReversalDetails {
        type RestrictedReason = 'already_reversed' | 'deadline_passed' | 'network_restricted' | 'other' | 'source_flow_restricted' | OtherString;
    }
}
