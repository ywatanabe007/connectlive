...
import { MetadataParam, OtherString, AddressParam, Metadata, Address } from '../../shared.js';
...
export declare namespace PaymentEvaluation {
    ...
    type RecommendedAction = 'block' | 'continue' | OtherString;
    interface Signals {
        /**
    ...
    namespace Event {
        ...
        type Type = 'dispute_opened' | 'early_fraud_warning_received' | 'refunded' | 'user_intervention_raised' | 'user_intervention_resolved' | OtherString;
        ...
        namespace DisputeOpened {
            type Reason = 'account_not_available' | 'credit_not_processed' | 'customer_initiated' | 'duplicate' | 'fraudulent' | 'general' | 'noncompliant' | 'product_not_received' | 'product_unacceptable' | 'subscription_canceled' | 'unrecognized' | OtherString;
        }
        namespace EarlyFraudWarningReceived {
            type FraudType = 'made_with_lost_card' | 'made_with_stolen_card' | 'other' | 'unauthorized_use_of_card' | OtherString;
        }
        namespace Refunded {
            type Reason = 'duplicate' | 'fraudulent' | 'other' | 'requested_by_customer' | OtherString;
        }
        namespace UserInterventionRaised {
            ...
            type Type = '3ds' | 'captcha' | 'custom' | OtherString;
        }
        namespace UserInterventionResolved {
            type Outcome = 'abandoned' | 'failed' | 'passed' | OtherString;
        }
    }
    namespace Outcome {
        ...
        type Type = 'failed' | 'merchant_blocked' | 'rejected' | 'succeeded' | OtherString;
        namespace MerchantBlocked {
            type Reason = 'authentication_required' | 'blocked_for_fraud' | 'invalid_payment' | 'other' | OtherString;
        }
        namespace Rejected {
            interface Card {
                /**
            ...
            namespace Card {
                type AddressLine1Check = 'fail' | 'pass' | 'unavailable' | 'unchecked' | OtherString;
                type AddressPostalCodeCheck = 'fail' | 'pass' | 'unavailable' | 'unchecked' | OtherString;
                type CvcCheck = 'fail' | 'pass' | 'unavailable' | 'unchecked' | OtherString;
                type Reason = 'authentication_failed' | 'do_not_honor' | 'expired' | 'incorrect_cvc' | 'incorrect_number' | 'incorrect_postal_code' | 'insufficient_funds' | 'invalid_account' | 'lost_card' | 'other' | 'processing_error' | 'reported_stolen' | 'try_again_later' | OtherString;
            }
        }
        namespace Succeeded {
            interface Card {
    ...
    namespace PaymentDetails {
        ...
        namespace MoneyMovementDetails {
            ...
            namespace Card {
                type CustomerPresence = 'off_session' | 'on_session' | OtherString;
                type PaymentType = 'one_off' | 'recurring' | 'setup_one_off' | 'setup_recurring' | OtherString;
            }
        }
