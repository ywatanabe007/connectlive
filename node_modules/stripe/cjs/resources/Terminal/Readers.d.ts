...
export declare class ReaderResource extends StripeResource {
     ...
     */
    del(id: string, params?: Terminal.ReaderDeleteParams, options?: RequestOptions): Promise<Response<DeletedReader>>;
    /**
     * Retrieves a Reader object.
     */
    retrieve(id: string, params?: Terminal.ReaderRetrieveParams, options?: RequestOptions): Promise<Response<Reader | DeletedReader>>;
    /**
     * Updates a Reader object by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
     */
    update(id: string, params?: Terminal.ReaderUpdateParams, options?: RequestOptions): Promise<Response<Reader | DeletedReader>>;
    /**
...
export declare namespace Reader {
    ...
    namespace Action {
        ...
        type Type = 'collect_inputs' | 'collect_payment_method' | 'confirm_payment_intent' | 'print_content' | 'process_payment_intent' | 'process_setup_intent' | 'refund_payment' | 'set_reader_display' | OtherString;
        namespace ApiError {
