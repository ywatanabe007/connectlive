...
import { MetadataParam, Decimal, Emptyable, PaginationParams, Metadata, OtherString } from '../../shared.js';
...
export declare namespace Order {
    ...
    type CancellationReason = 'expired' | 'product_unavailable' | 'requested' | OtherString;
    ...
    type Status = 'awaiting_funds' | 'canceled' | 'confirmed' | 'delivered' | 'open' | OtherString;
