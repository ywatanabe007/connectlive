...
import { MetadataParam, OtherString, Emptyable, AddressParam, PaginationParams, Metadata, Address } from '../shared.js';
...
export declare class PaymentMethodResource extends StripeResource {
     ...
     */
    create(params?: PaymentMethodCreateParams, options?: RequestOptions): Promise<Response<PaymentMethod>>;
    /**
     ...
     */
    retrieve(id: string, params?: PaymentMethodRetrieveParams, options?: RequestOptions): Promise<Response<PaymentMethod>>;
    /**
     * Updates a PaymentMethod object. A PaymentMethod must be attached to a customer to be updated.
     */
    update(id: string, params?: PaymentMethodUpdateParams, options?: RequestOptions): Promise<Response<PaymentMethod>>;
    /**
...
export declare namespace PaymentMethod {
    ...
    namespace Card {
        ...
        namespace Wallet {
            ...
            type Type = 'amex_express_checkout' | 'apple_pay' | 'google_pay' | 'link' | 'masterpass' | 'samsung_pay' | 'visa_checkout';
    ...
    namespace UsBankAccount {
        ...
        namespace StatusDetails {
            ...
            namespace Blocked {
                type NetworkCode = 'R02' | 'R03' | 'R04' | 'R05' | 'R07' | 'R08' | 'R10' | 'R11' | 'R16' | 'R20' | 'R29' | 'R31' | OtherString;
                type Reason = 'bank_account_closed' | 'bank_account_frozen' | 'bank_account_invalid_details' | 'bank_account_restricted' | 'bank_account_unusable' | 'debit_not_authorized' | 'tokenized_account_number_deactivated' | OtherString;
            }
        }
    }
}
...
export declare namespace PaymentMethodCreateParams {
    ...
    namespace Card {
        ...
        namespace Networks {
            type Preferred = 'cartes_bancaires' | 'mastercard' | 'visa' | OtherString;
        }
    }
    namespace Eps {
        type Bank = 'arzte_und_apotheker_bank' | 'austrian_anadi_bank_ag' | 'bank_austria' | 'bankhaus_carl_spangler' | 'bankhaus_schelhammer_und_schattera_ag' | 'bawag_psk_ag' | 'bks_bank_ag' | 'brull_kallmus_bank_ag' | 'btv_vier_lander_bank' | 'capital_bank_grawe_gruppe_ag' | 'deutsche_bank_ag' | 'dolomitenbank' | 'easybank_ag' | 'erste_bank_und_sparkassen' | 'hypo_alpeadriabank_international_ag' | 'hypo_bank_burgenland_aktiengesellschaft' | 'hypo_noe_lb_fur_niederosterreich_u_wien' | 'hypo_oberosterreich_salzburg_steiermark' | 'hypo_tirol_bank_ag' | 'hypo_vorarlberg_bank_ag' | 'marchfelder_bank' | 'oberbank_ag' | 'raiffeisen_bankengruppe_osterreich' | 'schoellerbank_ag' | 'sparda_bank_wien' | 'volksbank_gruppe' | 'volkskreditbank_ag' | 'vr_bank_braunau';
...
export declare namespace PaymentMethodUpdateParams {
    type AllowRedisplay = 'always' | 'limited' | 'unspecified' | OtherString;
    interface BillingDetails {
        /**
         * Billing address.
