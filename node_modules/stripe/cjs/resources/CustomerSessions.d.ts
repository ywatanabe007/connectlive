...
export declare namespace CustomerSession {
    ...
    namespace Components {
        ...
        namespace CustomerSheet {
            ...
            namespace Features {
                type PaymentMethodAllowRedisplayFilter = 'always' | 'limited' | 'unspecified' | OtherString;
        ...
        namespace MobilePaymentElement {
            ...
            namespace Features {
                type PaymentMethodAllowRedisplayFilter = 'always' | 'limited' | 'unspecified' | OtherString;
                type PaymentMethodRedisplay = 'disabled' | 'enabled' | OtherString;
                type PaymentMethodRemove = 'disabled' | 'enabled' | OtherString;
                type PaymentMethodSave = 'disabled' | 'enabled' | OtherString;
                type PaymentMethodSaveAllowRedisplayOverride = 'always' | 'limited' | 'unspecified' | OtherString;
            }
        }
        namespace PaymentElement {
            ...
            namespace Features {
                ...
                type PaymentMethodRemove = 'disabled' | 'enabled' | OtherString;
                type PaymentMethodSave = 'disabled' | 'enabled' | OtherString;
                type PaymentMethodSaveUsage = 'off_session' | 'on_session' | OtherString;
            }
        }
    }
}
...
export declare namespace CustomerSessionCreateParams {
    interface Components {
        /**
