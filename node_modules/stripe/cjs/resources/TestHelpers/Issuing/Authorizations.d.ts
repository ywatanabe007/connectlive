...
export declare class AuthorizationResource extends StripeResource {
     ...
     */
    create(params: TestHelpers.Issuing.AuthorizationCreateParams, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
     * Capture a test-mode authorization.
     */
    capture(id: string, params?: TestHelpers.Issuing.AuthorizationCaptureParams, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
     * Expire a test-mode Authorization.
     */
    expire(id: string, params?: TestHelpers.Issuing.AuthorizationExpireParams, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
     * Finalize the amount on an Authorization prior to capture, when the initial authorization was for an estimated amount.
     */
    finalizeAmount(id: string, params: TestHelpers.Issuing.AuthorizationFinalizeAmountParams, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
     * Respond to a fraud challenge on a testmode Issuing authorization, simulating either a confirmation of fraud or a correction of legitimacy.
     */
    respond(id: string, params: TestHelpers.Issuing.AuthorizationRespondParams, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
     * Increment a test-mode Authorization.
     */
    increment(id: string, params: TestHelpers.Issuing.AuthorizationIncrementParams, options?: RequestOptions): Promise<Response<Authorization>>;
    /**
     * Reverse a test-mode Authorization.
     */
    reverse(id: string, params?: TestHelpers.Issuing.AuthorizationReverseParams, options?: RequestOptions): Promise<Response<Authorization>>;
}
export declare namespace TestHelpers {
    namespace Issuing {
        ...
        namespace AuthorizationCreateParams {
            ...
            type AuthorizationMethod = 'chip' | 'contactless' | 'keyed_in' | 'online' | 'swipe' | OtherString;
            interface Fleet {
                /**
            ...
            type FraudDisputabilityLikelihood = 'neutral' | 'unknown' | 'very_likely' | 'very_unlikely' | OtherString;
            interface Fuel {
                /**
            ...
            type Wallet = 'apple_pay' | 'google_pay' | 'samsung_pay' | OtherString;
            namespace Fleet {
            ...
            namespace RiskAssessment {
                ...
                namespace CardTestingRisk {
                    type Level = 'elevated' | 'highest' | 'low' | 'normal' | 'not_assessed' | 'unknown' | OtherString;
                }
                namespace FraudRisk {
                    type Level = 'elevated' | 'highest' | 'low' | 'normal' | 'not_assessed' | 'unknown' | OtherString;
                }
            ...
            namespace VerificationData {
                type AddressLine1Check = 'match' | 'mismatch' | 'not_provided' | OtherString;
                type AddressPostalCodeCheck = 'match' | 'mismatch' | 'not_provided' | OtherString;
                ...
                type CvcCheck = 'match' | 'mismatch' | 'not_provided' | OtherString;
                type ExpiryCheck = 'match' | 'mismatch' | 'not_provided' | OtherString;
                ...
                namespace AuthenticationExemption {
                    type ClaimedBy = 'acquirer' | 'issuer' | OtherString;
                    type Type = 'low_value_transaction' | 'transaction_risk_analysis' | 'unknown' | OtherString;
                }
                namespace ThreeDSecure {
                    type Result = 'attempt_acknowledged' | 'authenticated' | 'failed' | 'required' | OtherString;
                }
            }
        }
    }
