...
import { MetadataParam, Emptyable, OtherString, PaginationParams, RangeQueryParam, Metadata, Address } from '../../shared.js';
...
export declare namespace VerificationSession {
    ...
    type Status = 'canceled' | 'processing' | 'requires_input' | 'verified' | OtherString;
    ...
    namespace LastError {
        type Code = 'abandoned' | 'consent_declined' | 'country_not_supported' | 'device_not_supported' | 'document_expired' | 'document_type_not_supported' | 'document_unverified_other' | 'email_unverified_other' | 'email_verification_declined' | 'id_number_insufficient_document_data' | 'id_number_mismatch' | 'id_number_unverified_other' | 'phone_unverified_other' | 'phone_verification_declined' | 'selfie_document_missing_photo' | 'selfie_face_mismatch' | 'selfie_manipulated' | 'selfie_unverified_other' | 'under_supported_age' | OtherString;
    }
    namespace Options {
        interface Document {
            /**
        ...
        namespace Matching {
            type Dob = 'none' | 'similar' | OtherString;
            type Name = 'none' | 'similar' | OtherString;
        }
    }
    namespace Redaction {
