...
export declare namespace Dispute {
    ...
    namespace Evidence {
        ...
        type Reason = 'canceled' | 'duplicate' | 'fraudulent' | 'merchandise_not_as_described' | 'no_valid_authorization' | 'not_received' | 'other' | 'service_not_as_described' | OtherString;
        ...
        namespace Canceled {
            type ProductType = 'merchandise' | 'service' | OtherString;
            type ReturnStatus = 'merchant_rejected' | 'successful' | OtherString;
        }
