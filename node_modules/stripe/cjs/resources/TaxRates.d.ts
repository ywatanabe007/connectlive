...
import { MetadataParam, OtherString, Emptyable, PaginationParams, RangeQueryParam, Metadata } from '../shared.js';
import { RequestOptions, ApiListPromise, Response } from '../lib.js';
export declare class TaxRateResource extends StripeResource {
    /**
     * Returns a list of your tax rates. Tax rates are returned sorted by creation date, with the most recently created tax rates appearing first.
     */
    list(params?: TaxRateListParams, options?: RequestOptions): ApiListPromise<TaxRate>;
    /**
     * Creates a new tax rate.
     */
    create(params: TaxRateCreateParams, options?: RequestOptions): Promise<Response<TaxRate>>;
    /**
     * Retrieves a tax rate with the given ID
     */
    retrieve(id: string, params?: TaxRateRetrieveParams, options?: RequestOptions): Promise<Response<TaxRate>>;
    /**
     * Updates an existing tax rate.
     */
    update(id: string, params?: TaxRateUpdateParams, options?: RequestOptions): Promise<Response<TaxRate>>;
}
...
export declare namespace TaxRate {
    ...
    type RateType = 'flat_amount' | 'percentage' | OtherString;
...
export declare namespace TaxRateCreateParams {
    type TaxType = 'amusement_tax' | 'communications_tax' | 'gst' | 'hst' | 'igst' | 'jct' | 'lease_tax' | 'mass_transit_parking_tax' | 'parking_tax' | 'pst' | 'qst' | 'retail_delivery_fee' | 'rst' | 'sales_tax' | 'service_tax' | 'vat' | OtherString;
}
...
export declare namespace TaxRateUpdateParams {
    type TaxType = 'amusement_tax' | 'communications_tax' | 'gst' | 'hst' | 'igst' | 'jct' | 'lease_tax' | 'mass_transit_parking_tax' | 'parking_tax' | 'pst' | 'qst' | 'retail_delivery_fee' | 'rst' | 'sales_tax' | 'service_tax' | 'vat' | OtherString;
}
