...
import { PaginationParams, Emptyable, MetadataParam, AddressParam, OtherString, Metadata, Address } from '../shared.js';
...
export declare class PaymentRecordResource extends StripeResource {
     ...
     */
    list(params?: PaymentRecordListParams, options?: RequestOptions): ApiListPromise<PaymentRecord>;
    /**
...
export declare namespace PaymentRecord {
    ...
    type ReportedBy = 'self' | 'stripe' | OtherString;
    ...
    namespace PaymentMethodDetails {
        ...
        namespace Card {
            type Brand = 'amex' | 'cartes_bancaires' | 'diners' | 'discover' | 'eftpos_au' | 'interac' | 'jcb' | 'link' | 'mastercard' | 'unionpay' | 'unknown' | 'visa' | OtherString;
            interface Checks {
                /**
            ...
            type Funding = 'credit' | 'debit' | 'prepaid' | 'unknown' | OtherString;
            interface Installments {
                /**
            ...
            type Network = 'amex' | 'cartes_bancaires' | 'diners' | 'discover' | 'eftpos_au' | 'interac' | 'jcb' | 'link' | 'mastercard' | 'unionpay' | 'unknown' | 'visa' | OtherString;
            ...
            namespace ThreeDSecure {
                ...
                type ElectronicCommerceIndicator = '01' | '02' | '03' | '04' | '05' | '06' | '07';
                ...
                type Version = '1.0.2' | '2.1.0' | '2.2.0' | OtherString;
            }
            namespace Wallet {
                interface ApplePay {
                    /**
        ...
        namespace Konbini {
            ...
            namespace Store {
                type Chain = 'familymart' | 'lawson' | 'ministop' | 'seicomart' | OtherString;
            }
        }
        namespace KrCard {
...
export declare namespace PaymentRecordReportPaymentParams {
    interface AmountRequested {
        /**
         * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
         */
    ...
    type Outcome = 'failed' | 'guaranteed' | OtherString;
    interface ProcessorDetails {
        /**
...
export declare namespace PaymentRecordReportPaymentAttemptParams {
    interface Failed {
        /**
         * When the reported payment failed. Measured in seconds since the Unix epoch.
         */
...
export declare namespace PaymentRecordReportPaymentAttemptInformationalParams {
    interface CustomerDetails {
        /**
         * The customer who made the payment.
         */
...
export declare namespace PaymentRecordReportRefundParams {
    interface ProcessorDetails {
        /**
