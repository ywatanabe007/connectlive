...
import { OtherString, AddressParam, JapanAddressParam, Emptyable, MetadataParam } from '../shared.js';
import { RequestOptions, Response } from '../lib.js';
export declare class TokenResource extends StripeResource {
    /**
     * Retrieves the token with the given ID.
     */
    retrieve(id: string, params?: TokenRetrieveParams, options?: RequestOptions): Promise<Response<Token>>;
    /**
