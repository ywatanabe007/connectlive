...
export declare namespace Token {
    type Network = 'mastercard' | 'visa' | OtherString;
    ...
    type Status = 'active' | 'deleted' | 'requested' | 'suspended' | OtherString;
    type WalletProvider = 'apple_pay' | 'google_pay' | 'samsung_pay' | OtherString;
    namespace NetworkData {
        ...
        type Type = 'mastercard' | 'visa' | OtherString;
        interface Visa {
            /**
        ...
        namespace Device {
            type Type = 'other' | 'phone' | 'watch' | OtherString;
        }
        namespace WalletProvider {
            type CardNumberSource = 'app' | 'manual' | 'on_file' | 'other' | OtherString;
...
export declare namespace Issuing {
    ...
    namespace TokenUpdateParams {
        type Status = 'active' | 'deleted' | 'suspended' | OtherString;
    }
}
export declare namespace Issuing {
