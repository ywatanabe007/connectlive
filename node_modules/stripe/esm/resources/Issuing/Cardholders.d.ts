...
import { MetadataParam, Address, Emptyable, OtherString, PaginationParams, RangeQueryParam, Metadata } from '../../shared.js';
...
export declare namespace Cardholder {
    ...
    type PreferredLocale = 'de' | 'en' | 'es' | 'fr' | 'it' | OtherString;
    ...
    type Status = 'active' | 'blocked' | 'inactive' | OtherString;
    type Type = 'company' | 'individual' | OtherString;
    ...
    namespace Requirements {
        type DisabledReason = 'listed' | 'rejected.listed' | 'requirements.past_due' | 'under_review' | OtherString;
        type PastDue = 'company.tax_id' | 'individual.card_issuing.user_terms_acceptance.date' | 'individual.card_issuing.user_terms_acceptance.ip' | 'individual.dob.day' | 'individual.dob.month' | 'individual.dob.year' | 'individual.first_name' | 'individual.last_name' | 'individual.verification.document' | OtherString;
    }
