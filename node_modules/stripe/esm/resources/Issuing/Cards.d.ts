...
import { MetadataParam, Emptyable, OtherString, Address, PaginationParams, RangeQueryParam, Metadata } from '../../shared.js';
...
export declare namespace Card {
    ...
    type Status = 'active' | 'canceled' | 'inactive' | OtherString;
    type Type = 'physical' | 'virtual' | OtherString;
    interface Wallets {
    ...
    namespace LatestFraudWarning {
        type Type = 'card_testing_exposure' | 'fraud_dispute_filed' | 'third_party_reported' | 'user_indicated_fraud' | OtherString;
    }
    ...
    namespace Shipping {
        ...
        type Carrier = 'correos' | 'dhl' | 'fedex' | 'royal_mail' | 'usps' | OtherString;
        interface Customs {
            /**
        ...
        type Service = 'express' | 'priority' | 'standard' | OtherString;
        type Status = 'canceled' | 'delivered' | 'failure' | 'pending' | 'returned' | 'shipped' | 'submitted' | OtherString;
        type Type = 'bulk' | 'individual' | OtherString;
        namespace AddressValidation {
            type Mode = 'disabled' | 'normalization_only' | 'validation_and_normalization' | OtherString;
            type Result = 'indeterminate' | 'likely_deliverable' | 'likely_undeliverable' | OtherString;
        }
    }
    namespace SpendingControls {
        ...
        namespace SpendingLimit {
            ...
            type Interval = 'all_time' | 'daily' | 'monthly' | 'per_authorization' | 'weekly' | 'yearly' | OtherString;
        }
    }
    namespace Wallets {
        interface ApplePay {
        ...
        namespace ApplePay {
            type IneligibleReason = 'missing_agreement' | 'missing_cardholder_contact' | 'unsupported_region' | OtherString;
        }
        namespace GooglePay {
            type IneligibleReason = 'missing_agreement' | 'missing_cardholder_contact' | 'unsupported_region' | OtherString;
        }
