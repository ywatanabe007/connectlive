...
import { Emptyable, MetadataParam, PaginationParams, RangeQueryParam, OtherString, Metadata, Decimal } from '../../shared.js';
...
export declare namespace Authorization {
    ...
    type CardPresence = 'not_present' | 'present' | OtherString;
    interface Fleet {
        /**
    ...
    type Status = 'closed' | 'expired' | 'pending' | 'reversed' | OtherString;
    interface Treasury {
        /**
    ...
    namespace Fleet {
        ...
        type PurchaseType = 'fuel_and_non_fuel_purchase' | 'fuel_purchase' | 'non_fuel_purchase' | OtherString;
        ...
        type ServiceType = 'full_service' | 'non_fuel_transaction' | 'self_service' | OtherString;
    ...
    namespace FraudChallenge {
        type Status = 'expired' | 'pending' | 'rejected' | 'undeliverable' | 'verified' | OtherString;
        type UndeliverableReason = 'no_phone_number' | 'unsupported_phone_number' | OtherString;
    }
    namespace Fuel {
        type Type = 'diesel' | 'other' | 'unleaded_plus' | 'unleaded_regular' | 'unleaded_super' | OtherString;
        type Unit = 'charging_minute' | 'imperial_gallon' | 'kilogram' | 'kilowatt_hour' | 'liter' | 'other' | 'pound' | 'us_gallon' | OtherString;
    }
