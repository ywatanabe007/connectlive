...
export declare class ChargeResource extends StripeResource {
     ...
     */
    create(params?: ChargeCreateParams, options?: RequestOptions): Promise<Response<Charge>>;
    /**
     * Retrieves the details of a charge that has previously been created. Supply the unique charge ID that was returned from your previous request, and Stripe will return the corresponding charge information. The same information is returned when creating or refunding the charge.
     */
    retrieve(id: string, params?: ChargeRetrieveParams, options?: RequestOptions): Promise<Response<Charge>>;
    /**
     * Updates the specified charge by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
     */
    update(id: string, params?: ChargeUpdateParams, options?: RequestOptions): Promise<Response<Charge>>;
    /**
     ...
     */
    search(params: ChargeSearchParams, options?: RequestOptions): ApiSearchResultPromise<Charge>;
    /**
...
export declare namespace Charge {
    ...
    namespace Outcome {
        type AdviceCode = 'confirm_card_data' | 'do_not_try_again' | 'try_again_later';
        interface Rule {
            /**
...
export declare namespace ChargeCreateParams {
...
export declare namespace ChargeUpdateParams {
    interface FraudDetails {
        /**
