...
export declare namespace Hold {
    type CreatedBy = 'application' | 'stripe' | OtherString;
    type Reason = 'charge' | 'standalone' | OtherString;
    ...
    type SourceType = 'bank_account' | 'card' | 'fpx' | OtherString;
}
