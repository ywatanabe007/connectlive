...
export declare namespace Transaction {
    ...
    type FlowType = 'credit_reversal' | 'debit_reversal' | 'inbound_transfer' | 'issuing_authorization' | 'other' | 'outbound_payment' | 'outbound_transfer' | 'received_credit' | 'received_debit' | OtherString;
    type Status = 'open' | 'posted' | 'void' | OtherString;
    ...
    namespace FlowDetails {
        type Type = 'credit_reversal' | 'debit_reversal' | 'inbound_transfer' | 'issuing_authorization' | 'other' | 'outbound_payment' | 'outbound_transfer' | 'received_credit' | 'received_debit' | OtherString;
    }
}
...
export declare namespace Treasury {
    ...
    namespace TransactionListParams {
        type OrderBy = 'created' | 'posted_at' | OtherString;
        type Status = 'open' | 'posted' | 'void' | OtherString;
        interface StatusTransitions {
            /**
