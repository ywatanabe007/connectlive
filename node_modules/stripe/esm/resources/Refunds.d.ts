...
import { Emptyable, MetadataParam, PaginationParams, RangeQueryParam, Metadata, OtherString } from '../shared.js';
...
export declare class RefundResource extends StripeResource {
     ...
     */
    retrieve(id: string, params?: RefundRetrieveParams, options?: RequestOptions): Promise<Response<Refund>>;
    /**
     * Updates the refund that you specify by setting the values of the passed parameters. Any parameters that you don't provide remain unchanged.
     *
     * This request only accepts metadata as an argument.
     */
    update(id: string, params?: RefundUpdateParams, options?: RequestOptions): Promise<Response<Refund>>;
    /**
     * Cancels a refund with a status of requires_action.
     *
     * You can't cancel refunds in other states. Only refunds for payment methods that require customer action can enter the requires_action state.
     */
    cancel(id: string, params?: RefundCancelParams, options?: RequestOptions): Promise<Response<Refund>>;
}
...
export declare namespace Refund {
    ...
    type PendingReason = 'charge_pending' | 'insufficient_funds' | 'processing' | OtherString;
    ...
    type Reason = 'duplicate' | 'expired_uncaptured_charge' | 'fraudulent' | 'requested_by_customer' | OtherString;
    namespace DestinationDetails {
        ...
        namespace Card {
            type Type = 'pending' | 'refund' | 'reversal' | OtherString;
        }
    }
