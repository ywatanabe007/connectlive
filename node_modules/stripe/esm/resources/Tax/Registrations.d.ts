...
export declare namespace Registration {
    ...
    type Status = 'active' | 'expired' | 'scheduled' | OtherString;
    namespace CountryOptions {
        ...
        namespace Ae {
            ...
            namespace Standard {
                type PlaceOfSupplyScheme = 'inbound_goods' | 'standard' | OtherString;
            }
        }
        namespace At {
            interface Standard {
            ...
            type Type = 'ioss' | 'oss_non_union' | 'oss_union' | 'standard' | OtherString;
            namespace Standard {
                type PlaceOfSupplyScheme = 'inbound_goods' | 'small_seller' | 'standard' | OtherString;
            }
        }
        namespace Au {
            interface Standard {
        ...
        namespace Ca {
            ...
            type Type = 'province_standard' | 'simplified' | 'standard' | OtherString;
        }
        namespace Ch {
            interface Standard {
                /**
        ...
        namespace Us {
            ...
            type Type = 'local_amusement_tax' | 'local_lease_tax' | 'mass_transit_parking_tax' | 'parking_tax' | 'state_communications_tax' | 'state_retail_delivery_fee' | 'state_sales_tax';
            namespace StateSalesTax {
                ...
                namespace Election {
                    type Type = 'local_use_tax' | 'simplified_sellers_use_tax' | 'single_local_use_tax' | OtherString;
                }
            }
        }
    }
...
export declare namespace Tax {
    ...
    namespace RegistrationListParams {
        type Status = 'active' | 'all' | 'expired' | 'scheduled' | OtherString;
    }
}
