...
import { Emptyable, AddressParam, MetadataParam, OtherString, PaginationParams, RangeQueryParam, Address, Metadata } from '../shared.js';
...
export declare namespace Customer {
    ...
    namespace Tax {
        type AutomaticTax = 'failed' | 'not_collecting' | 'supported' | 'unrecognized_location' | OtherString;
        interface Location {
            /**
        ...
        type Provider = 'anrok' | 'avalara' | 'sphere' | 'stripe' | OtherString;
        namespace Location {
            type Source = 'billing_address' | 'ip_address' | 'payment_method' | 'shipping_destination' | OtherString;
        }
    }
}
...
export declare namespace CustomerCreateParams {
    ...
    namespace Tax {
        type ValidateLocation = 'deferred' | 'immediately' | OtherString;
    }
...
export declare namespace CustomerUpdateParams {
    ...
    namespace Tax {
        type ValidateLocation = 'auto' | 'deferred' | 'immediately' | OtherString;
    }
}
...
export declare namespace CustomerCreateFundingInstructionsParams {
    ...
    namespace BankTransfer {
        ...
        type RequestedAddressType = 'iban' | 'sort_code' | 'spei' | 'zengin' | OtherString;
