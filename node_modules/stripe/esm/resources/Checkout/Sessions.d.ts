...
export declare class SessionResource extends StripeResource {
     ...
     */
    list(params?: Checkout.SessionListParams, options?: RequestOptions): ApiListPromise<Session>;
    /**
     ...
     */
    retrieve(id: string, params?: Checkout.SessionRetrieveParams, options?: RequestOptions): Promise<Response<Session>>;
    /**
     ...
     */
    expire(id: string, params?: Checkout.SessionExpireParams, options?: RequestOptions): Promise<Response<Session>>;
    /**
