...
export declare class SetupIntentResource extends StripeResource {
     ...
     */
    list(params?: SetupIntentListParams, options?: RequestOptions): ApiListPromise<SetupIntent>;
    /**
     ...
     */
    create(params?: SetupIntentCreateParams, options?: RequestOptions): Promise<Response<SetupIntent>>;
    /**
     ...
     */
    retrieve(id: string, params?: SetupIntentRetrieveParams, options?: RequestOptions): Promise<Response<SetupIntent>>;
    /**
     * Updates a SetupIntent object.
     */
    update(id: string, params?: SetupIntentUpdateParams, options?: RequestOptions): Promise<Response<SetupIntent>>;
    /**
     * You can cancel a SetupIntent object when it's in one of these statuses: requires_payment_method, requires_confirmation, or requires_action.
     *
     * After you cancel it, setup is abandoned and any operations on the SetupIntent fail with an error. You can't cancel the SetupIntent for a Checkout Session. [Expire the Checkout Session](https://docs.stripe.com/docs/api/checkout/sessions/expire) instead.
     */
    cancel(id: string, params?: SetupIntentCancelParams, options?: RequestOptions): Promise<Response<SetupIntent>>;
    /**
     ...
     */
    confirm(id: string, params?: SetupIntentConfirmParams, options?: RequestOptions): Promise<Response<SetupIntent>>;
    /**
     * Verifies microdeposits on a SetupIntent object.
     */
    verifyMicrodeposits(id: string, params?: SetupIntentVerifyMicrodepositsParams, options?: RequestOptions): Promise<Response<SetupIntent>>;
}
export interface SetupIntent {
     ...
     */
    livemode: boolean;
    managed_payments?: SetupIntent.ManagedPayments | null;
    /**
...
export interface SetupIntentUpdateParams {
     ...
     * The list of payment method types to exclude from use with this SetupIntent.
     */
    excluded_payment_method_types?: Emptyable<Array<SetupIntentUpdateParams.ExcludedPaymentMethodType>>;
    /**
     * Specifies which fields in the response should be expanded.
     */
    expand?: Array<string>;
...
export declare namespace SetupIntentCancelParams {
    type CancellationReason = 'abandoned' | 'duplicate' | 'requested_by_customer';
}
